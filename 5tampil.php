    ...
    <div class="container-fluid text-center">
        <div class="row">
            ...
            <div class="col-12">
                ...
                echo "<thead>";
                echo "<tr>";
                echo "<th scope = \"row\">";                echo "No";                echo "</th>";
                echo "<th scope = \"row\">";                echo "Kode";              echo "</th>";
                echo "<th scope = \"row\">";                echo "Nama Barang";       echo "</th>";
                echo "<th scope = \"row\">";                echo "Jenis";             echo "</th>";
                echo "<th scope = \"row\">";                echo "Lokasi";            echo "</th>";
                echo "<th scope = \"row\">";                echo "Harga";             echo "</th>";
                echo "<th scope = \"row\">";                echo "Stok";              echo "</th>";
                echo "</tr>";
                echo "</thead>";
